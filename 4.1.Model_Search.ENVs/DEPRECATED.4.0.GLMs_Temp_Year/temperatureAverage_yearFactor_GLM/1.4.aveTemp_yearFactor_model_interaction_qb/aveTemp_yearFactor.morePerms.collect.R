...
### collect results
  perm.sets <- list.files("/scratch/aob2x/dest_glm_morePerms_nested_qb/rawGLM", ".csv", full.name=T)
...
#  save(glm.out, file=paste("/scratch/aob2x/summarized_dest_glm/glm.out.", glm.out[1]$locality, "_", glm.out[1]$perm, ".Rdata", sep=""))
  save(glm.out, file=paste("/scratch/aob2x/dest_glm_morePerms_nested_qb/processedGLM/glm.out.", glm.out[1]$locality, "_", glm.out[1]$perm, ".Rdata", sep=""))
