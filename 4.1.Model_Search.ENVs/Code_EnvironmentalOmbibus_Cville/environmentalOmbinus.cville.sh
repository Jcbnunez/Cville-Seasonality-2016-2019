...
# sbatch --array=1-5000%100 /scratch/aob2x/Overwintering_18_19/EnvironmentalOmbibus_Cville/environmentalOmbinus.cville.sh
# sacct -j 38161033 | tail
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_38161033_471.err
...
cd /scratch/aob2x/
Rscript Overwintering_18_19/EnvironmentalOmbibus_Cville/environmentalOmbinus.cville.R ${SLURM_ARRAY_TASK_ID} 5000
