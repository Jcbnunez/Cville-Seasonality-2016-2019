...
# sbatch --array=1-5000%100 /scratch/aob2x/Overwintering_18_19/EnvironmentalOmnibus_Global/environmentalOmbinus.global_redoNAM.sh
# sacct -j 40117491 | tail
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_40117491_1.err
...
cd /scratch/aob2x/
Rscript Overwintering_18_19/EnvironmentalOmnibus_Global/environmentalOmbinus.global_redoNAM.R ${SLURM_ARRAY_TASK_ID} 5000
