...
#SBATCH -t 6:00:00 ### 20 minutes per job per 10 permutations
#SBATCH --mem 100G
...
# sbatch --array=21-266 /scratch/aob2x/Overwintering_18_19/EnvironmentalOmnibus_Global/environmentalOmbinus.global.collect2.sh
# sacct -j 40413009
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_40393914_1.err
...
cd /scratch/aob2x/
Rscript Overwintering_18_19/EnvironmentalOmnibus_Global/environmentalOmbinus.global.collect2.R ${SLURM_ARRAY_TASK_ID}
