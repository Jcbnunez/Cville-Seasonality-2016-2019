...
### load in jobs files
  jobs <- fread("~/Overwintering_18_19/pheno/pheno_jobs.csv")
...
### save
  save(gwas.win.o, file=paste("/scratch/aob2x/gwas_glm_merge_window/window_", jobId, ".Rdata", sep=""))
