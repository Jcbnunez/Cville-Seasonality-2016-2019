...
out.days = foreach(f = c(1:5), .combine = "rbind") %do% {
  ...
  wd =  paste0("/Users/supad/OneDrive/Documents/Bergland Research/R_data_objects/Aug_2022_objects/week3crossdata/", ref.values[[4]]  )
  setwd( wd )
  ...
  flygeno.key = fread(paste0("/Users/supad/OneDrive/Documents/Bergland Research/R_data_objects/Aug_2022_objects/wellguides/well.guide3." , f, ".csv"), header = T)
...
setwd( wd )
saveRDS(out.days, paste0("week3.def.data"))
out.days = readRDS("week3.def.data")
