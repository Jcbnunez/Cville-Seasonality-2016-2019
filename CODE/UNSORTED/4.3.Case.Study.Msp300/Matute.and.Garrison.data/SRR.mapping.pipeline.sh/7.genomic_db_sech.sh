...
#Name of pipeline
PIPELINE=GenomicsDBImport.sech

# User defined inputs -- this represents the name of the samples
sp=sech
sample_map=/scratch/yey2sn/Overwintering_ms/msp300.case/sech_samps.to.haplo.txt
#This file looks like this
#  sample1      sample1.vcf.gz
#  sample2      sample2.vcf.gz
#  sample3      sample3.vcf.gzs
#Intervals to analyze for each species
intervals=sech.intervals.txt

######
#Working folder is core folder where this pipeline is being run.
WORKING_FOLDER=/scratch/yey2sn/Overwintering_ms/msp300.case/
DB_location=/project/berglandlab/Drosophilids_datasets_yak_sech_sim_maur/Genomics_db_sech
