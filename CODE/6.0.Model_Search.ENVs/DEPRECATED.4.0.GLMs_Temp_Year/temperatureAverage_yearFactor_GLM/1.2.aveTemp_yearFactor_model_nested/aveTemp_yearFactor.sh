...
# sbatch --array=1-1000 ~/Overwintering_18_19/temperatureAverage_yearFactor_GLM/1.2.aveTemp_yearFactor_model_nested/aveTemp_yearFactor.sh
# sacct -j 28760741
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_28760741_1.err
...
cd ~/
Rscript Overwintering_18_19/temperatureAverage_yearFactor_GLM/1.2.aveTemp_yearFactor_model_nested/aveTemp_yearFactor.R ${SLURM_ARRAY_TASK_ID} 1000
