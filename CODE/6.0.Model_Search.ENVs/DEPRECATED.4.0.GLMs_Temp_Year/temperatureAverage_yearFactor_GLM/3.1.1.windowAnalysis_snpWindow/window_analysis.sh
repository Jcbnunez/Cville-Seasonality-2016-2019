...
# sbatch --array=607 ~/Overwintering_18_19/temperatureAverage_yearFactor_GLM/3.1.windowAnalysis_bpWindow/window_analysis.sh
# sacct -j 33221811
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_33221811_607.err
...
cd ~/
Rscript Overwintering_18_19/temperatureAverage_yearFactor_GLM/3.1.windowAnalysis_bpWindow/window_analysis.R ${SLURM_ARRAY_TASK_ID}
