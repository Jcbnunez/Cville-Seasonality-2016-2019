...
# sbatch --array=1-709 ~/Overwintering_18_19/temperatureAverage_yearFactor_GLM/1.3.aveTemp_yearFactor_model_nested_qb/aveTemp_yearFactor.morePerms.collect_part2.sh
# sacct -j 34562989
