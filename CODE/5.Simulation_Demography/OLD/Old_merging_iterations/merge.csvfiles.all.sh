...
/project/berglandlab/connor/bottleneck/data.condense/freq.output.new.afvar.${nMax}.${nMin}.csv

# Remove header and rbind EUC
awk 'FNR > 1' ${output}/freq.output.new.euc.${nMax}.${nMin}.*.csv > \
/project/berglandlab/connor/bottleneck/data.condense/freq.output.new.euc.${nMax}.${nMin}.csv

# Remove header and rbind FST
awk 'FNR > 1' ${output}/freq.output.new.fst.${nMax}.${nMin}.*.csv > \
/project/berglandlab/connor/bottleneck/data.condense/freq.output.new.fst.${nMax}.${nMin}.csv
