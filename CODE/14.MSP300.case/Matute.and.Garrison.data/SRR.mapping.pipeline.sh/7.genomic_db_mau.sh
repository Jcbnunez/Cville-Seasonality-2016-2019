...
#Name of pipeline
PIPELINE=GenomicsDBImport.mau

# User defined inputs -- this represents the name of the samples
sp=mau
sample_map=/scratch/yey2sn/Overwintering_ms/msp300.case/mau_samps.to.haplo.txt
...
DB_location=/project/berglandlab/Drosophilids_datasets_yak_sech_sim_maur/Genomics_db_mau
