...
#python $Gff2Gtf --input $gff > GCF_000001215.4_Release_6_plus_ISO1_MT_genomic.gtf
	...
	java -Xmx35g \
	-jar $Gowinda \
	--snp-file all_noTresh_glm_universe.txt \
	--candidate-snp-file glm_2L_outliers_at_5.glm_outliers.txt \
	...
	--threads 10 \
	--output-file GOWINDA_out_2Lt5binomGLM_SNPmode_100kperms.txt \
	--mode snp \
	--min-genes 1 \
	--detailed-log
