...
#### load snp metadata
load("./EUW.glm.and.matchedControls.Rdata")
set = "macthed.controls.Inv"
...
seqSetFilter(genofile, 
             ...
             variant.id=macthed.controls.Inv$id)
...
save(Out_comp_vector_samepops, 
     file = paste(set,"EUW.Year_to_year_object.Rdata", sep = "." ))
...
save(snp.wise.tmp.f.df, 
     file = paste(set,"EUW.snp.wise.tmp.f.df.Rdata", sep = "." ))
