...
# sbatch --array=1-101 ~/Overwintering_18_19/Core20_enrichment/DEST_core20/core20_enrichment.sh
# sacct -j 37482644
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_37482644_1.out
...
cd ~/
Rscript Overwintering_18_19/Core20_enrichment/DEST_core20/core20_enrichment.R ${SLURM_ARRAY_TASK_ID}
