...
# sbatch --array=1-707 ~/Overwintering_18_19/temperatureAverage_yearFactor_GLM/2.InversionEnrichmentAnalysis/inversion_enrichment.sh
# sacct -j 28737676
...
cd ~/
Rscript Overwintering_18_19/temperatureAverage_yearFactor_GLM/2.InversionEnrichmentAnalysis/inversion_enrichment.R ${SLURM_ARRAY_TASK_ID}
