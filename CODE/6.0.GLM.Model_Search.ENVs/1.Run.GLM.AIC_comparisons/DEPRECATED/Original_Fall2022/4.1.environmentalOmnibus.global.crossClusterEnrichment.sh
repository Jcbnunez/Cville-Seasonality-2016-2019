...
# sbatch --array=1-112 /scratch/aob2x/Overwintering_18_19/EnvironmentalOmnibus_Global/environmentalOmnibus.global.crossClusterEnrichment.sh
# sacct -j 39852697
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_39852697_1.err
...
cd /scratch/aob2x/
Rscript Overwintering_18_19/EnvironmentalOmnibus_Global/environmentalOmnibus.global.crossClusterEnrichment.R ${SLURM_ARRAY_TASK_ID}
