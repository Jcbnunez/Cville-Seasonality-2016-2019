...
#SBATCH --ntasks-per-node=30 # ten cores
...
# sbatch --array=1-532 /scratch/aob2x/Overwintering_18_19/EnvironmentalOmnibus_Global/redoPerm/environmentalOmbinus.global.collect2.glmRNP.sh
# sacct -j 52796470
...
cd /scratch/aob2x/
Rscript Overwintering_18_19/EnvironmentalOmnibus_Global/redoPerm/environmentalOmbinus.global.collect2.glmRNP.R ${SLURM_ARRAY_TASK_ID}
