...
save(win.out, file = "Temp2.cville.windowAnalysis.Rdata")
load("/scratch/yey2sn/Overwintering_ms/4.2.env.omibus.mods/Temp2.cville.windowAnalysis.Rdata")
...
ggsave(rnpv.dist.temp + wZa.dist.temp, h = 4, w = 8,  file = "wza.rnpv.dist.temp.pdf")  
