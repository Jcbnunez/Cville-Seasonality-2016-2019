...
#SBATCH --array=1-8055%50

#load module
module load plink

#make folder
out_folder=ld_plink_INV
mkdir $out_folder
...
#load input data
vcf=VA_ch_0.05_ith0.forLD.2l.INV.recode.vcf.gz ### Notice this is the INV vcf
snp_guide_file=VA_ch_0.05_ith0.forLD.2l.INV.iterator.txt ### Notie this is the INV karyo
