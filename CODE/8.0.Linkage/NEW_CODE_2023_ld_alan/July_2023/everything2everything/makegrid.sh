...
### sbatch --array=446,447,834,835,836,913,914,949,950 ~/Overwintering_18_19/ld_alan/everything2everything/makegrid.sh

### sacct -j 49930817
### cat /scratch/aob2x/everythingLD/logs/runGrid.49930817_446*.err
### cat /scratch/aob2x/everythingLD/logs/runGrid.49889342*.err

s#acct -j 49906492 | grep "TIME" | cut -f2 -d'_' | cut -f1 -d' ' | tr '\n' ','
