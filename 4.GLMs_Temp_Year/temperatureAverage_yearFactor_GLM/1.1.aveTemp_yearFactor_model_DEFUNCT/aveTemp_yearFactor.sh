...
#SBATCH -t 0:90:00 ### 20 minutes per job per 10 permutations
#SBATCH --mem 35G
...
# sbatch --array=1-1000 ~/Overwintering_18_19/temperatureAverage_yearFactor_GLM/aveTemp_yearFactor.sh
# sacct -j 28566643
# cat /scratch/aob2x/lasso_dest/slurmOut/cm_lasso_28561442_1.err
...
cd ~/
Rscript Overwintering_18_19/temperatureAverage_yearFactor_GLM/aveTemp_yearFactor.R ${SLURM_ARRAY_TASK_ID} 1000
