...
# sbatch --array=1-707 ~/Overwintering_18_19/temperatureAverage_yearFactor_GLM/3.2.windowAnalysis_snpWindow/window_analysis.sh
# sacct -j 28880290
...
cd ~/
Rscript Overwintering_18_19/temperatureAverage_yearFactor_GLM/3.2.windowAnalysis_snpWindow/window_analysis.R ${SLURM_ARRAY_TASK_ID}
